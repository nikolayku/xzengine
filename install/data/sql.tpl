...
INSERT INTO `{tableperfix}news` VALUES ('xzengine 1.7 beta 6', '<p>&nbsp;</p><div style="text-align: center"><img src="{sitepath}/upload/boxsmall.jpg" alt="xzengine 1.7 beta 6" title="xzengine 1.7 beta 6" width="237" height="368" /></div> <p>&nbsp;</p><p align="left">Двиг xzengine обновился до версии v.1.5 beta 6<br />Функции<br />1) поддержка GZip<br />2) поддержка Rss<br />3) Поддержка статических страниц (для сосдания дорвеев и переадресации)<br />4) Загрузка файлов а сервер<br />5) поддержка скинов админпанели и самого сайта<br />6) поддержка статических страниц и ЧПУ<br />7) редактирование шаблонов из админпанели<br />8) управление списком ключевых слов для каждой новости</p><p align="left">То что добавлено в новой версии читаем в подробнее </p>', 'xzengine team', '', 1216701386, 0, 1, 1, 1, '<div style="text-align: center"><img src="{sitepath}/upload/boxsmall.jpg" alt="xzengine 1.7 beta 6" title="xzengine 1.7 beta 6" width="237" height="368" /></div> <p align="left">Двиг xzengine обновился до версии v.1.5 beta 6<br /> Функции<br /> 1) поддержка GZip<br /> 2) поддержка Rss<br /> 3) Поддержка статических страниц (для сосдания дорвеев и переадресации)<br /> 4) Загрузка файлов а сервер<br /> 5) поддержка скинов админпанели и самого сайта<br /> 6) поддержка статических страниц и ЧПУ<br /> </p><p align="left">То что добавлено в новой версии читаем в подробнее </p><p align="left">В новой версии добавлено<br />1) для администратора - возможность выделять текст <font size="2"><strong>размером</strong> <font size="0">и <font size="1" color="{forum_path}ff6600">цветом</font></font></font></p><p align="left">2) Добавлена возможность редактирования шаблонов через админпанель с удобной подсветкой синтаксиса<br />3) Добавлено добавление ключевых слов для каждой новости и для главной страницы сайта. Появился новый тег <strong>{keyword} </strong></p>', 1, 1, 'xzengine 1.7 beta 6 скачать, скачать xzengine, система управления сайтом');
