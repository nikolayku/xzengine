...
define("lang_addnews_edit", 'News is edit <a href="{sitepath_admin}/admin/index.php?listnews"> Back to site </a>');
define("lang_addnews_add", 'News is added <a href="{sitepath_admin}/index.php"> Back to site </a>');
